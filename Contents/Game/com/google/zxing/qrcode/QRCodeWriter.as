...
package com.google.zxing.qrcode
{
    ...
    { 
    	  ...
    	  //QUIET_ZONE_SIZE modified private to public 11.0321 by hideskei@naver.com
          public static var QUIET_ZONE_SIZE:int = 4;	//default : 4
		  //ERROR_CORRECTION_LEVEL added for control by host code
		  public static var ERROR_CORRECTION_LEVEL: ErrorCorrectionLevel = ErrorCorrectionLevel.L;
          ...
          public function encode(contents:String, format:BarcodeFormat=null, width:int=0,height:int=0, hints:HashTable=null):Object
          {
			...
			//public static 변수로 뺌 11.0321 hideskei@naver.com
//            var errorCorrectionLevel:ErrorCorrectionLevel = ErrorCorrectionLevel.L;
			var errorCorrectionLevel:ErrorCorrectionLevel = ERROR_CORRECTION_LEVEL;
            if (hints != null) 
            {
