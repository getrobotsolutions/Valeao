...
// get the screen height and width
    ...
    document.getElementById('dialog-box').innerHTML = '<a href="#" class="button">Close</a><div class="dialog-content"><div id="dialog-message"><video id="myVideo" autoplay><source src="'+ src+'" type="video/mp4"></video></div></div>';
}